...
<html lang="en">
  <head>
    ...
    <title>fixmystreet|||Dashboard</title>
    <!-- plugins:css -->
...
?>
                          <span class="report-title">Total Provinces</span>
                          <h4><?php echo htmlentities($totclass);?></h4>
                          <a href="manage-class.php"><span class="report-count"> View provinces</span></a>
                        </div>
                      ...
                      <div class="col-md-6 col-xl report-inner-card">
                        <div class="inner-card-text">
                          <?php 
                        $sql2 ="SELECT * from  councilor";
$query2 = $dbh -> prepare($sql2);
$query2->execute();
$results2=$query2->fetchAll(PDO::FETCH_OBJ);
$totstu=$query2->rowCount();
?>
                          <span class="report-title">Total councilor</span>
                          <h4><?php echo htmlentities($totstu);?></h4>
                          <a href="manage-students.php"><span class="report-count"> View councilor</span></a>
                        </div>
...
?>
                          <span class="report-title">Total province Notice</span>

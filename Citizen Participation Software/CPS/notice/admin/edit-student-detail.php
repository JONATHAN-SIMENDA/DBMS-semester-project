...
if (strlen($_SESSION['sturecmsaid']==0)) {
 ...
 $eid=$_GET['editid'];
$sql="update councilor set StudentName=:stuname,StudentEmail=:stuemail,StudentClass=:stuclass,Gender=:gender,DOB=:dob,StuID=:stuid,FatherName=:fname,MotherName=:mname,ContactNumber=:connum,AltenateNumber=:altconnum,Address=:address where ID=:eid";
...
<html lang="en">
  <head>
    ...
    <title>fixmystreet|| Update councilor</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Update councilor </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> Update councilor</li>
                </ol>
              </nav>
            </div>
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Update councilor</h4>
                   
                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                      <?php
$eid=$_GET['editid'];
$sql="SELECT councilor.StudentName,councilor.StudentEmail,councilor.StudentClass,councilor.Gender,councilor.DOB,councilor.StuID,councilor.FatherName,councilor.MotherName,councilor.ContactNumber,councilor.AltenateNumber,councilor.Address,councilor.UserName,councilor.Password,councilor.Image,councilor.DateofAdmission,province.ClassName,province.Section from councilor join province on province.ID=councilor.StudentClass where councilor.ID=:eid";
$query = $dbh -> prepare($sql);
$query->bindParam(':eid',$eid,PDO::PARAM_STR);
$query->execute();

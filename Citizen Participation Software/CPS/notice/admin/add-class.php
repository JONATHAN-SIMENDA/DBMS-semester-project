...
$sql="insert into province(ClassName,Section)values(:cname,:section)";
...
<html lang="en">
  <head>
    ...
    <title>fixmystreet|| Add province</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Add province </h3>
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Add province</h4>
